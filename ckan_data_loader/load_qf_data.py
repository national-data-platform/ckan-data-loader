...
from wifire_stmary_large_dataset.dataset_metadata import ORGANIZATION_DATA, DATASET_METADATA
...
def create_resource(pck_id, resource_metadata):
    ...
    file_path = Path(__file__).parent / "wifire_stmary_large_dataset" /"resources" / resource_metadata['upload'] \
...
if __name__ == '__main__':
    try:
        ...
        print("Prepopulation didn't happen. Probably it was done before.")
